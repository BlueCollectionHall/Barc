...
class BackgroundImageServiceTest {
    ...
    void upload_invalidModule() {
        ResponseEntity<J> response = backgroundImageService.uploadService("admin-uuid", image, "not-a-module");
    ...
    void upload_emptyFile() {
        ...
        ResponseEntity<J> response = backgroundImageService.uploadService("admin-uuid", empty, "home");
        assertEquals(1, response.getBody().getCode());
    }
    ...
    void upload_tooLarge() {
        ...
        ResponseEntity<J> response = backgroundImageService.uploadService("admin-uuid", large, "home");
        assertEquals(1, response.getBody().getCode());
        verify(cosService, never()).uploadFileWithKey(any(), anyString(), any());
    }
    ...
    void upload_notImage() {
        ...
        ResponseEntity<J> response = backgroundImageService.uploadService("admin-uuid", txt, "home");
        assertEquals(1, response.getBody().getCode());
    }
    ...
    void upload_success() {
        ...
        ResponseEntity<J> response = backgroundImageService.uploadService("admin-uuid", image, "home");
    ...
    void publicAll_groupsByModule() {
        ...
        @SuppressWarnings("unchecked")
        Map<String, List<String>> grouped = (Map<String, List<String>>) result.getData();
        assertEquals(List.of("https://signed/home"), grouped.get("home"));
        assertEquals(List.of("https://signed/sign"), grouped.get("sign"));
    }
}
